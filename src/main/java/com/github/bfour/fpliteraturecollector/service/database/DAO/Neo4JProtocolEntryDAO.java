...
@Service
@Configurable
public class Neo4JProtocolEntryDAO extends AbstractNeo4JDAO<ProtocolEntry> implements
		ProtocolEntryDAO {

	@Autowired
	private Neo4JProtocolEntryDAODelegate delegate;
	
	@Autowired
	private Neo4jTemplate neoTemplate;

	public Neo4JProtocolEntryDAO() {
	}

	@Override
	protected GraphRepository<ProtocolEntry> getDelegate() {
		return delegate;
	}
